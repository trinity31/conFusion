...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $localStorage, 
  ...
  $scope.doReserve = function() {
    ...
    $timeout(function() { $scope.closeReserve();
      $scope.closeReserve();
    }, 1000);
  };    
  ...
  $scope.addFavorite = function (index) {
      ...
      $ionicPlatform.ready(function() {
        $cordovaLocalNotification.schedule({
          ...
          console.log('Added Favorites ' + $scope.dishes[index].name);
        }, function() {
          console.log('Failed to add Notification ');
        });

        $cordovaToast.show('Added Favorites ' + $scope.dishes[index].name, 'long', 'center')
...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'favoriteFactory', 'baseURL',
        '$ionicPopover', '$ionicListDelegate', '$ionicModal', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast',
        function($scope, $stateParams, dish, menuFactory, 
          favoriteFactory, baseURL, $ionicPopover, $ionicListDelegate, $ionicModal, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) { 
    $scope.baseURL = baseURL;         
    $scope.dish = dish;
    $scope.comment = {rating:5, comment:"", author:"", date:""};

    console.log('dish ID is ' + $scope.dish.id);
    ...
    $scope.addFavorite = function() {
      console.log("Add dish ID " + $scope.dish.id + " to Favorites");
      ...
      $ionicPlatform.ready(function() {
        ...
        $cordovaToast.show('Added Favorites ' + $scope.dish.name, 'long', 'center')
          .then(function(success) {
            //success
          }, function(error) {
            //error
    ...
    $scope.submitComment = function() {
        ...
        menuFactory.update({id:$scope.dish.id}, $scope.dish); //push back to server     
        $scope.closeComment();
        $scope.comment = {rating:5, comment:"", author:"", date:""};
        $scope.closePopover();
    };
